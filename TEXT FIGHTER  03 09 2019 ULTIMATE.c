...
main()
{
int dice1, dice2, dice3, dice4, dice5, dice6, diceB, diceC, diceE, diceF, diceG, diceL, diceM, diceN, diceP = 0, diceQ = 0, diceR = 0, diceQ1 = 0;
...
if (((wnrtrec > wnrtrec3) && (torwnrt >= wnrt) && (wnrtrec >= wnrt) && (wnrtrec >= torwnrt) && (cpuwn2 <= 1)) || ((wnrtrec > wnrtrec3) && (torwnrt <= wnrt) && (wnrtrec >= wnrt) && (wnrtrec >= torwnrt) && (cpuwn2 <= 1)) || ((wnrtrec > wnrtrec3) && (torwnrt < wnrt) && (wnrtrec < wnrt) && (wnrtrec > torwnrt) && (cpuwn2 >= 0)) || ((wnrtrec > wnrtrec3) && (torwnrt < wnrt) && (wnrtrec < wnrt) && (wnrtrec == torwnrt) && (cpuwn2 >= 0)))
{
Sleep (300);
...
if ((cpuwn2 >= 1) && (torwnrt < wnrt) && (wnrtrec == wnrtrec3) && (wnrtrec < wnrt) && (torwnrt == wnrtrec3))
{
printf("\n     ");
++prntcor;
}
...
if ((cpuwn2 > 1) && (torwnrt < wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec3 > 0))
{
printf("\n     ");
++prntcor;
}
...
if (((cpuwn2 > 0) && (torwnrt == wnrt) && (wnrtrec3 > 0) && (wnrtrec > wnrtrec3) && (wnrt > wnrtrec3)) || ((cpuwn2 > 0) && (torwnrt > wnrt) && (wnrtrec > wnrtrec3) && (wnrt > wnrtrec3)) || ((cpuwn2 > 0) && (torwnrt > wnrt) && (wnrtrec > wnrtrec3) && (wnrt < wnrtrec3)))
{
printf("  ");
}
...
if ((torwnrt > 0) && (cpuwn2 >= 1) && (torwnrt < wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec == wnrt) && (torwnrt == wnrtrec3))
{
printf("  ");
}
if ((cpuwn2 == 1) && (wnrtrec3 == 0) && (torwnrt == wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec > wnrt) && (torwnrt > wnrtrec3))
{
printf("  ");
}
if ((cpuwn2 == 1) && (wnrtrec3 == 0) && (torwnrt == wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec == wnrt) && (torwnrt > wnrtrec3))
...
if ((cpuwn2 == 1) && (wnrtrec3 == 0) && (torwnrt < wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec > wnrt) && (torwnrt == wnrtrec))
{
printf("  ");
}
if ((cpuwn2 > 1) && (torwnrt < wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec3 == 0))
...
if (((ctr < 7) &&  (cpusp > 1) && (new6 > 0)) || ((ctr < 7) &&  (cpusp < 2) && (new6 < 1)) || ((ctr < 7) &&  (cpusp < 2) && (new6 > 0)) || ((ctr < 7) && (cpusp > 1) && (new6 < 1)))
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("\n     Could anyone have ever doubted the outcome of this contest?\n");
if (diceQ == 2)
printf("\n     How is it possible for anyone to be able to even do this?\n");
if (diceQ == 3)
printf("\n     Only the most dedicated to their training can attain such abilities!\n");
}
...
if (((new6 < 1) && (ctr > 5) && (cpusp > 1)) || ((new6 < 1) && (ctr > 5) && (cpusp < 2))) ///|| ((new6 < 1) && (ctr < 6) && (cpusp > 1))) //this now out?
printf("\n");
if (ctr < 6)
...
if (((new6 < 1) && (ctr > 5) && (cpusp > 1)) || ((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp > 1)) || ((new6 < 1)  && (cpusp < 2) && (ctr < 6)) || ((new6 < 1)  && (cpusp < 2) && (ctr > 5)))
printf("\n");
if ((new6 > 0) && (cpusp > 1) && (ctr < 6))
...
if (diceQ == 2)
printf("     That was insane!\n");
if (diceQ == 3)
printf("     That was an unreal contest!\n");
if (diceQ == 4)
printf("     That was a magnificent fight!\n");
...
{
if (diceQ == 1)
printf("     It was a superb follow-up!\n");
if (diceQ == 2)
printf("     It was a powerful follow-up attack!\n");
if (diceQ == 3)
...
if (cpusp > 1)
printf("     You have a Special Round Chain of %d!\n", cpusp);
if (((cpusp > 1) && (ctr > 4) && (new6 > 0)) || ((cpusp > 1) && (ctr < 5) && (new6 < 1)))
printf("\n");
...
if (diceQ == 2)
printf("     That was superbly skilled!\n");
if (diceQ == 3)
...
if (diceQ == 2)
printf("     That was an awesome fight!\n");
if (diceQ == 3)
printf("     A thrilling victory!\n");
if (diceQ == 4)
...
if ((new6 > 0) && (cpusp > 1) && (ctr < 6))
printf("     It was a fantastic finish!\n");
if (((new6 < 1) && (ctr > 5) && (cpusp > 1)) || ((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp > 1)) || ((new6 < 1)  && (cpusp < 2) && (ctr < 6)) || ((new6 > 0) && (cpusp < 2) && (ctr < 6)))
printf("\n");
if ((new6 > 0) && (cpusp > 1) && (ctr < 6))
...
{
diceE = (rand() % 24 + diflev + diceR) + 1;//maybe 28
}
else
{
if ((choice == 'n') && (choice != 'm') && (choice != 's'))
diceE = (rand() % 32 + diflev) + 1;//maybe 32 0r 34
}
if  ((diceE > 20) && (diceB >= 4) && (diceB <= 6) && (playerhp > 0) && (emagsup < 1) && (emagsup5 < 1) && (emagsup6 < 1))
{
playerhp = (playerhp - 6);
...
diceF = (rand() % 42 + diflev + diceR) + 1; //42
else
if ((choice == 'm') && (choice != 's') && (choice != 'n'))
diceF = (rand() % 54 + diflev) + 1; //54
}
if  ((diceF > 30) && (diceB >= 5) && (diceB <= 6) && (playerhp > 0) && (emagsup < 1))
{
playerhp = (playerhp - 8);
...
diceC = (rand() % 86 + diflev + diceR) + 1; //86
}//added
...
if (diceQ == 2)
printf("     THAT'S AN AWESOME CPU MAGIC COMBO!\n");
if (diceQ == 3)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     IT WAS A MAGNIFICENT CPU MAGIC WIN!\n\n");
if (diceQ == 2)
printf("     THAT WAS AN UNBEATABLE MAGIC WIN!\n\n");
if (diceQ == 3)
printf("     AND AN UNBEATABLE MAGIC VICTORY!\n\n");
}
}
...
if (((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && (hypsp2 > 0) && (spatt2 > 0) && (enspcomb6 < 1) && (diflev > 6))
emagsup6 = 1;
...
if (diceQ == 2)
printf("     You saw the opening and didn't let up!\n");
if (diceQ == 3)
...
if ((diceB == 2) || (diceB == 3) || (diceB == 4) || (diceB == 5) || (diceB == 6))
{
...
if (diceQ == 9)
printf("     You have to keep your guard up!\n\n");
diceQ1 = (rand() % 44) + 1;//14 16 32 38 42
if ((diceQ > 9) && (diceQ1 < 11))
printf("\n");
if (diceQ1 == 1)
...
if (diceQ1 == 5)
printf("     Don't let it get you down!\n\n");
if (diceQ1 == 6)
